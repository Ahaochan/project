package moe.ahao.spring.boot.swagger.config;

import moe.ahao.util.commons.lang.CollectionHelper;
...
public class SwaggerConfig {
    ...
    public Docket globalDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("moe.ahao"))
    ...
    public Docket controllerDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("moe.ahao.spring.boot.swagger.controller"))
                .paths(PathSelectors.any())
