...
import moe.ahao.spring.boot.transaction.seata.tcc.service.OutTransferService;
...
@Component
public class OutTransferServiceImpl implements OutTransferService {
    ...
    public void confirm(BusinessActionContext actionContext) throws Exception {
        ...
        Long accountId = transferDTO.getAccountId();
        BigDecimal amount = transferDTO.getAmount();
        logger.info("confirm阶段开始, 出账, 单号:{}, accountId:{}, amount:{}", transferNo, accountId, amount);
