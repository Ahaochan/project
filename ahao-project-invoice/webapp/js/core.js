(function ($) {
    ...
    $.extend({
        ...
        province: function (option) {
            ...
            var taxId = options.taxId, invoiceCode = options.invoiceCode, provinceCode = options.provinceCode;

            if (!!provinceCode) {
                return province[provinceCode] || '';
            }
            if (!!taxId) {
                return municipality[taxId.substring(2, 8)] || '';
            }
            if (!!invoiceCode) {
                return municipality[invoiceCode.substring(0, 4) + '00'] || '';
            }
