package moe.ahao.web.module.upload.config;

import moe.ahao.web.module.upload.config.properties.UploadProperties;
import moe.ahao.web.module.upload.service.UploadService;
import moe.ahao.web.module.upload.service.impl.UploadServiceLocalImpl;
