...
id_path varchar(200) COLLATE utf8mb4_bin not null default '' comment '节点路径, 用逗号分隔',
...
KEY `idx_relation_link` (id_path(50)) using btree
...
insert into table_tree(id, root_id, parent_id, is_leaf, level, id_path, name)values
(1, 0, 0, 0, 1, '1',        'name1'),
(2, 1, 1, 0, 2, '1,2',      'name2'),
(3, 1, 1, 0, 2, '1,3',      'name3'),
(4, 1, 1, 0, 2, '1,4',      'name4'),
...
# 查询 id 为 2 的所有子孙节点
select * from table_tree where id_path like concat((select id_path from table_tree where id = 2), ',%')
