package com.ahao.spring.boot.wechat.mp.controller;
...
import static com.ahao.spring.boot.wechat.mp.aop.AppIdCheckAOP.APP_ID;
...
public class WxPortalController {
     ...
     * 使用 AOP 进行参数校验
     * @param echoStr 随机字符串
     * @see com.ahao.spring.boot.wechat.mp.aop.AppIdCheckAOP
     * @see com.ahao.spring.boot.wechat.mp.aop.SignCheckAOP
